...
Defined in: [features/row-pinning/rowPinningFeature.utils.ts:234](https://github.com/TanStack/table/blob/main/packages/table-core/src/features/row-pinning/rowPinningFeature.utils.ts#L234)

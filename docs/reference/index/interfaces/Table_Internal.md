...
Defined in: [types/Table.ts:92](https://github.com/TanStack/table/blob/main/packages/table-core/src/types/Table.ts#L92)
...
[`Table_Core`](Table_Core.md).[`_cellPrototype`](Table_Core.md#_cellprototype)
...
[`Table_Core`](Table_Core.md).[`_columnPrototype`](Table_Core.md#_columnprototype)
...
```ts
Omit._headerGroupInstanceInitFns
```
...
[`Table_Core`](Table_Core.md).[`_headerPrototype`](Table_Core.md#_headerprototype)
...
[`Table_Core`](Table_Core.md).[`_reactivity`](Table_Core.md#_reactivity)
...
Defined in: [types/Table.ts:103](https://github.com/TanStack/table/blob/main/packages/table-core/src/types/Table.ts#L103)
...
Defined in: [types/Table.ts:102](https://github.com/TanStack/table/blob/main/packages/table-core/src/types/Table.ts#L102)
...
[`Table_Core`](Table_Core.md).[`_rowPrototype`](Table_Core.md#_rowprototype)
...
Defined in: [types/Table.ts:110](https://github.com/TanStack/table/blob/main/packages/table-core/src/types/Table.ts#L110)
...
optional atoms: Partial<{
  cellSelection?: Atom<CellSelectionState>;
